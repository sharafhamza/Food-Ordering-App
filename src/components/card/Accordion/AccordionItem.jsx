      ...
      <div className="rounded-lg  flex items-start justify-between  bg-white gap-x-6">
        <div>
          ...
          <p className="text-gray-600 mt-2 text-base font-medium w-[600px]">
            "Crunchy Soft Paneer patty dunked in hot and sweet Korean glaze with
            Korean sesame mayo in premium Brioche buns for authentic Korean
            flavours. Qty: 228 Gms| Kcal: 695.26 | Carbs 67.94 Gms| Sugar: 16.99
            Gms| Fat: 38.07 Gms| Saturated fat: 15.82 Gms| Protein: 20.20 Gms|
            Sodium: 1744.70 Mg. Contains: Gluten, Soybean , Milk "
          </p>
        </div>
